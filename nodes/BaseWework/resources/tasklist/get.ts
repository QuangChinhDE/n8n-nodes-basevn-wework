...
export async function get(this: IExecuteFunctions, index: number): Promise<IDataObject> {
	...
	const response = await weworkApiRequest.call(this, 'POST', '/extapi/v3/tasklist/get', body);
